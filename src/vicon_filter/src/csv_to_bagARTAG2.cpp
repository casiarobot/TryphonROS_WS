...
int main(int argc, char **argv){
    ...
    ros::init(argc,argv,"csv_to_bagARTAG2");
    ros::NodeHandle n;
    ros::Publisher pose_pub = n.advertise<geometry_msgs::PoseStamped>("/192_168_10_243/artags2/artag/ar_pose_marker",1000);
    ros::Time startTime = ros::Time::now();
    ros::Rate loop_rate(10);

	// csvFile.open("nominal-maneuver-poseStamped.csv", std::ios::in);
	csvFile.open("/home/tryphon/ROSTryphon_groundstation/src/vicon_filter/path-maneuver-60Hz-fullMonteCarloARTAG2.csv", std::fstream::in | std::fstream::app);
