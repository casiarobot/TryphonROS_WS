...
int main(int argc, char **argv){
    ...
    ros::init(argc,argv,"csv_to_bag");
    ros::NodeHandle n;
    ros::Publisher pose_pub = n.advertise<geometry_msgs::PoseStamped>("artag1_sim",1000);
    ros::Time startTime = ros::Time::now();
    ros::Rate loop_rate(10);

	// csvFile.open("nominal-maneuver-poseStamped.csv", std::ios::in);
	csvFile.open("path-maneuver-60Hz-fullMonteCarloARTAG1.csv", std::fstream::in | std::fstream::app);
