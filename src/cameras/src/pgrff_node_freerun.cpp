...
#include <cameras/pgrff_node_freerunConfig.h>
...
void callback(cameras::pgrff_node_freerunConfig &config, uint32_t level) {
...
{	
    ...
    dynamic_reconfigure::Server<cameras::pgrff_node_freerunConfig> server;
    dynamic_reconfigure::Server<cameras::pgrff_node_freerunConfig>::CallbackType f;
